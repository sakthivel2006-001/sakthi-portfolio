...
import bangzenLogo from '../assets/Lanyard/lanyard.png';
              ...
              <nav className="container mx-auto flex items-center justify-between flex-wrap pb-0 px-1">
                ...
                <div className="w-full flex items-center justify-between md:hidden">
                  ...
                  <a href="/" onClick={(e) => handleNavClick(e, '#home')} className="flex items-center gap-3">
                    ...
                    <div>
                      <h1 className="font-moderniz text-sm dark:text-[#00ffdc] text-slate-800 whitespace-nowrap">SAKTHIVEL S</h1>
                ...
                <div className="hidden w-full md:grid grid-cols-3 items-center px-8 relative min-h-[48px]">
                  ...
                  >
                    ...
                    <div className="block">
                      <h1 className="font-moderniz text-base dark:text-[#00ffdc] text-slate-800">SAKTHIVEL S</h1>
