...
const Contact = () => {
  ...
  const handleContactSubmit = async (e) => {
    ...
    try {
      ...
      alert(`Failed to send message: ${error.message}. Please ensure database connection is active.`);
    } finally {
  ...
  const handleCommentSubmit = async (e) => {
    ...
    try {
      ...
      alert(`Failed to post comment: ${error.message}. Please ensure database connection is active.`);
    } finally {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      icon: <FaGithub />,
      url: 'https://github.com/sakthivel2006-001',
    ...
    },
    {
      name: 'LinkedIn',
      icon: <FaLinkedin />,
      url: 'https://www.linkedin.com/in/sakthivel-s-a124a02a0/',
