...
const dummyProjects = [
  {
    title: "SJA Transport",
    description: "A transportation and logistics web application.",
    tech: ["React", "TailwindCSS", "Node.js"],
    link: "https://sja-transport-frontend.vercel.app/",
    image: "/sja-transport-logo.png",
    category: "Web/Apps",
  }
];

// ===================================
// DATA SERTIFIKAT SAKTHIVEL S
// ===================================
              ...
              {activeTab === 'Projects' && (
                <>
                  <div className="flex justify-center gap-4 mb-8">
                    <button className="px-5 py-2 rounded-full font-semibold transition-all duration-200 border bg-cyan-700/80 text-white border-cyan-400 shadow-cyan-500/10 shadow-lg cursor-default">Web/Apps</button>
                  </div>
                    ...
                    <>
                      {activeCertificates.length > 0 ? (
                        ...
                        <div className="col-span-full text-center text-slate-400 py-12">
                          ...
                          {certificatesFromDB.length === 0 && (
                            <div className="mt-4 text-sm text-emerald-400">
                              Add certificates via Admin Dashboard to see them here!
                            </div>
                          )}
                        </div>
                      )}
