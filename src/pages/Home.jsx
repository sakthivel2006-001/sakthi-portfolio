...
import { FaGithub, FaWhatsapp, FaLinkedin, FaDownload, FaBriefcase, FaCode, FaCertificate, FaGlobe, FaArrowRight, FaCube } from 'react-icons/fa';
...
import profilePhoto from '../assets/images/SAKTHIVEL.png';
...
const Home = () => {
    ...
    const stats = [
        ...
        { icon: <FaGlobe />, value: "1", title: "YEARS OF EXPERIENCE", description: "Continuous learning journey" },
    ];
        ...
        >
          ...
          ${is3dEnabled
            ...
            <section id="home" className="flex flex-col md:flex-row items-center gap-10 pt-20 pb-16 lg:pt-0 lg:pb-20">
                <div className="flex-1 dark:text-white text-slate-800 space-y-6 pt-16 md:pt-40 order-last md:order-none text-center md:text-left flex flex-col items-center md:items-start">
                    ...
                    <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.55, ease: "easeOut" }}>
                        <TextGenerateEffect words={'Building modern, responsive, and user-focused web applications'} />
                    </motion.div>
                    ...
                    <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 1.0, ease: "easeOut" }} className="flex flex-row gap-4 mt-8">
                        ...
                        <a href="https://wa.me/916379557214" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp Contact" className="group relative flex h-12 w-12 items-center justify-center rounded-full border dark:border-slate-700 border-slate-200 dark:bg-slate-900/[0.8] bg-white text-slate-600 dark:text-white transition-all duration-300 hover:border-cyan-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:shadow-md dark:hover:shadow-[0_0_24px_2px_#00ffdc]">
                        ...
                        <a href="https://www.linkedin.com/in/sakthivel-s-a124a02a0/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn Profile" className="group relative flex h-12 w-12 items-center justify-center rounded-full border dark:border-slate-700 border-slate-200 dark:bg-slate-900/[0.8] bg-white text-slate-600 dark:text-white transition-all duration-300 hover:border-cyan-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:shadow-md dark:hover:shadow-[0_0_24px_2px_#00ffdc]">
            ...
            >
                ...
                <div className="flex flex-col md:flex-row items-center justify-center">
                    ...
                    >
                        ...
                        <h3 className="text-4xl font-bold dark:text-white text-slate-900 my-2 font-moderniz" style={{ textShadow: theme === 'dark' ? "2px 2px 0 #000754, 4px 4px 0 #4079ff, 0 4px 12px #40ffaa, 0 1px 0 #00ffdc" : "none" }}>SAKTHIVEL S</h3>
                        <p className="dark:text-white/80 text-slate-600 leading-relaxed mt-4 font-cascadia text-justify">
                            I'm Sakthivel S, a B.Tech Information Technology student at Saveetha Engineering College and a passionate Full Stack Web Developer. I build modern, responsive, SEO-friendly web applications using React, Node.js, Express.js, MongoDB, and Firebase. My goal is to create fast, secure, scalable, and user-focused digital solutions that help businesses grow.
                        ...
                        <img src={profilePhoto} alt="SAKTHIVEL S portrait" className="mx-auto mb-8 w-48 h-48 rounded-full object-cover object-[center_15%] shadow-xl dark:border-slate-700 border-slate-200 border-4" />
            ...
            <footer className="py-12 pb-16 text-center text-gray-400 dark:bg-gradient-to-t dark:from-slate-900/50 dark:to-transparent bg-gradient-to-t from-slate-100/50 to-transparent">
                <div className="text-sm">© {new Date().getFullYear()} SAKTHIVEL S. All rights reserved.</div>
